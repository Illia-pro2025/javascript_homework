...
//  властивостей в об'єкті. Функція повертає число
//  — кількість властивостей.

// Завдання 3
// Напиши функцію findBestEmployee(employees), яка
//  приймає об'єкт співробітників і повертає ім'я
...
// Завдання 4
// Напиши функцію countTotalSalary(employees) приймаючу об'єкт
//  зарплат. Функція рахує загальну суму зарплати працівників
// і повертає її. Кожне поле об'єкта, переданого в функцію, має
//  вигляд "ім'я":"зарплата".

// Завдання 5
// Напиши функцію getAllPropValues(arr, prop), яка отримує масив
//  об'єктів і ім'я властивості. Повертає масив значень певної
// властивості prop з кожного об'єкта в масиві.

// Завдання 6
// Напиши функцію calculateTotalPrice(allProdcuts, productName),
//  яка отримує масив об'єктів та ім'я продукту (значення властивості
//  name). Повертає загальну вартість продукту (ціна * кількість).
